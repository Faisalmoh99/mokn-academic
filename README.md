...
> **ملاحظة عن التخصصات المتعددة:** اختيار عضو من خارج التخصص التقني (طب) كان قراراً مدروساً — لتجنب "الفقاعة الهندسية" والحصول على تقييم موضوعي لتجربة المستخدم وواقعية المشكلة المطروحة.
